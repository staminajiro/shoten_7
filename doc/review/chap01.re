...
Jetson Nano@<fn>{3694097c648da2e2cfccf94bf6da56c2}。ちっちゃいけどGPUも積んでるすごいやつ。今回はこいつを使って、ビリヤード場で簡単に撮影→変換ができるようにすることが目標です。



@<del>{しかしこいつが使われることはなかった・・・}
 ...
 * 斜めに写った画像をCanvasで矩形に補正する@<fn>{4dcd621de5f8b5011f0256fe7b60031d}
...
せっかくなのでこの機会にTypeScriptに入門したいと思い、一般的な四角形から矩形への射影変換をTypeScriptで実装することにしました。愚直に書いたのでGPUを使えず3FPSくらいが限度になりそうかなーと思いつつ実装。式はこの辺り@<fn>{c2db882b725ae2d2cb9e74c1f437e95a}を参考にしました。
...
//image[chapter01_prml][オフィスでの撮影][scale=0.5]{
//}
...
//image[chapter01_rack][][scale=0.5]{
//}
...
//image[chapter01_break][ブレイク後の配置][scale=0.5]{
//}




真上からの画像が見れるようになったので配置がよくわかりますね。@<del>{4回目のブレイクで}たまたま1番が隠れてしまったので頑張って当ててみようと思います。(下の丸が手玉(白玉)、上の丸が1番)。
...
//image[chapter01_thinking][右側から当たりそう！！(矢印は後から加工して入れました)][scale=0.5]{
//}
...
//footnote[3694097c648da2e2cfccf94bf6da56c2][https://www.nvidia.com/ja-jp/autonomous-machines/embedded-systems/jetson-nano/]

//footnote[4dcd621de5f8b5011f0256fe7b60031d][https://memo.sugyan.com/entry/2018/09/03/212712]

//footnote[c2db882b725ae2d2cb9e74c1f437e95a][http://kondolab.org/archive/2010/research/cadcgtext/ChapE/ChapE02.html]
